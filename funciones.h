...
void asignarValores(int d[], int tam, int j[], int pFinal[], bool testeo, bool &ganoPartida, bool manual, int  contTirada, int rondas, char vNombre[30]){
    system("cls");

    int i, x, p, opc2, opc3, opc4;
    bool elegido = false;
    int sumaPuntaje = sumarVector(pFinal, 10);
    tiradasTotales++;
